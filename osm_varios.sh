...
cat osm_varios/all_osm_varios.json | ./urlize.sh | grep -e '"recycling:batteries":"yes"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/battery.geojson

echo "Bulbs"
cat osm_varios/all_osm_varios.json | ./urlize.sh | grep -e '"recycling:light_bulbs":"yes"' -e '"recycling:low_energy_bulbs":"yes"' -e '"recycling:fluorescent_tubes":"yes"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/bulbs.geojson

echo "Cooking oil"
cat osm_varios/all_osm_varios.json | ./urlize.sh | grep -e '"recycling:cooking_oil":"yes"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/cooking_oil.geojson

echo "Metal"
cat osm_varios/all_osm_varios.json | ./urlize.sh | grep -e '"recycling:metal":"yes"' -e '"recycling:scrap_metal":"yes"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/metal.geojson
...
cat osm_varios/bulk.json | ./urlize.sh | grep -e '"bulk_purchase":"yes"' -e '"bulk_purchase":"only"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/bezobalace.geojson
...
cat osm_varios/vending.json | ./urlize.sh | grep -e '"milk"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/mlekomaty.geojson
...
cat osm_varios/hydrant.json | ./urlize.sh | grep -e '"fire_hydrant"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/hydrant.geojson
...
cat osm_varios/steps_no_count.json | ./urlize.sh | grep -e '"highway":"steps"' -e 'FeatureCollection' -e '^]}$' | grep -vi "count" | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/steps_no_count.geojson
...
cat osm_varios/bookcase.json | ./urlize.sh | grep -e '"public_bookcase"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/bookcase.geojson
...
cat osm_varios/aed.json | ./urlize.sh | grep -e '"defibrillator"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/aed.geojson
...
cat osm_varios/alcohol.json | ./urlize.sh | grep -e '"alcohol"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/alcohol.geojson
...
cat osm_varios/beershop.json | ./urlize.sh | grep -e '"shop"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/beershop.geojson
...
cat osm_varios/rescue.json | ./urlize.sh | grep -e '"emergency_access_point"' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/rescue.geojson
...
cat osm_varios/postbox.json | ./urlize.sh | grep -e '"post_box"' -e 'FeatureCollection' -e '^]}$' | grep -v '"ref"' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/postbox.geojson
echo "Create gpx"
...
cat osm_varios/brewery.json | ./urlize.sh | grep -e 'brewery' -e 'FeatureCollection' -e '^]}$' | tac | sed '2s/,$//' | tac | jq . > ./osm_varios/brewery.geojson
